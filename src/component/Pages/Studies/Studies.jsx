    ...
    return (
        <div className="lg:px-24 px-6 py-20 bg-white">
            <div className="lg:flex gap-5">
                <h2 className="text-4xl w-[251px] rounded-2xl text-center h-[51px] bg-[#B9FF66] text-black">Case Studies</h2>
            ...
            <div className="lg:flex w-auto h-[700px] lg:h-[326px] mt-12 rounded-2xl bg-black">
                <div className="lg:w-[386px] w-[345px] h-[163px] px-10 py-16">
                ...
                <div className="lg:w-[386px] w-[345px] h-[163px] lg:mt-0 mt-8 px-10 py-16">
                    <div className="lg:border-r-2 border-white h-[186px] ">
                        <p className="text-white">
