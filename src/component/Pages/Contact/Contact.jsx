    ...
    return (
        <div className="lg:px-24 px-2 py-10 bg-white">
            <div className="lg:flex gap-3">
                <h1 className="lg:text-4xl text-2xl lg:w-[229px] w-[180px] h-[40px] text-black bg-[#B9FF66] lg:h-[51px] text-center rounded-2xl">Contact Us</h1>
                        ...
                        <div className="card lg:w-[556px] w-[310px]  shrink-0">
                            ...
                            <form className="card-body">
                                <div className="form-control">
                                    <input type="text" placeholder="Name" className="lg:w-[556px] w-[250px] px-3 rounded-2xl bg-[#ffffff] text-black border-2 border-black h-[59px]" required />
                                </div>
                                <div className="form-control">
                                    <input type="email" placeholder="Email" className="lg:w-[556px] w-[250px] px-3 rounded-2xl bg-[#ffffff] text-black border-2 border-black h-[59px]" required />
                                </div>
                                <div className="form-control">
